...
- [x] 만약 내가 가진 돈이 기본 배팅금액 이하일 경우, all-in 되도록 해주세요. - 가진 돈이 베팅금액보다 적을 시, deal 버튼을 누르면 자동 all-in
...
- [ ] Split 기능을 만들어 주세요.
- [x] Surrender 기능을 구현하였습니다.
- [x] Ranking이 화면에 표시될 때, 정확한 Ranking인지 파악할 수 있도록 각 계정의 잔액을 표시했습니다.

### 버그 수정
- [ ] 어떤 버그가 또 있을까요..?
- [x] betting 후 backdoor기능을 이용 시, betting금액 초기화 현상
...
- [x] 각 기능 버튼에 대한 적절한 이미지를 삽입하고 hover
- [x] 배경 이미지 삽입
- [x] 배경 변환으로 인해 잘 보이지 않는 문자 디자인 개선
- [x] 폰트 변경 및 가독성 개선
## 문의
